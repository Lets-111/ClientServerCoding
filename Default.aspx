                    ...
                    <tr>
                        <td valign="top" width="60%">
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    <td align="center">
                                        <img src="images/banner11.jpg" /></td>
                                </tr>
                                <tr>
                                    <td align="justify">
                                        <div align="justify">
                                            ...
                                            <br />
                                            <br />3.    Organize mails in Logical Folders<br />
                                                4. It Provides Live Meeting (Chat) using Join Chat Room after Sucessfully login.&nbsp;<br />5.	Performing Admin functions like managing new user, resetting passwords etc.
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtPassword" runat="server" ValidationGroup="g1" Width="149px" TextMode="Password"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPassword"
                                                            ErrorMessage="*" Font-Bold="True" ValidationGroup="g1"
                                                            ToolTip="Enter Password"></asp:RequiredFieldValidator>&nbsp;<br /> &nbsp;<asp:Button ID="btnSignUp" runat="server" Text="Login" OnClick="btnSignUp_Click"
